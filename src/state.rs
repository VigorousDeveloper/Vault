use cosmwasm_std::{Addr, Env, Storage,StdResult,Uint128,Order};
use cosmwasm_storage::{singleton, singleton_read,bucket,bucket_read, ReadonlySingleton, Singleton};
...
pub const CONFIG_USERS:&[u8] = b"Users";
